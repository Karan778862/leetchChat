  ...
  return (
    ...
    <div className=" flex h-screen items-center justify-center bg-slate-800">
      <form
        ...
        className="w-[96] border border-white px-6 py-2 rounded-md space-y-3 "
      >
        ...
        {errors.confirmPassword && (
          <span className="text-red-600 text-1xl">
        ...
        <div className="flex text-white justify-between">
          <p>
            HaveAn Account{" "}
             ...
             <Link to="/login" className="text-orange-500 underline cursor-pointer ml-1"> Login</Link>
